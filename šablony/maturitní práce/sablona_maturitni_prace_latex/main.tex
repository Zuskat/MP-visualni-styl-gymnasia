% Doporučuji zkontrolovat požadavky na vzhled závěrečné práce, citace atd.
% Nadpisy jsou pouhými příklady, například maturitní práce na humanitní studia běžně neobsahuje technickou dokumentaci a může mít různé podoby.
% Šablona má sjednocovat závěrečné práce do jednoho stylu a usnadnit její sazbu, je ale možné, že si ji každý bude muset přizpůsobit dle vlastních potřeb.
% Font, velikosti písma atp. by měly ideálně zůstat stejné (pokud podmínky neurčují jinak.), aby se zachovala jednota stylu závěrečných prací. Titulní strana, zadání atp. by měly být pro všechny práce stejné.
